<?php
	...
	$check = mysqli_query($link,"SELECT * FROM Kingdom ");
				...
				<div class="collapse navbar-collapse" id="navbarNav">
				    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item active">
				        	<a class="nav-link" href="kingdoms.php">Kingdoms <span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
