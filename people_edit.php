	...
	<body>
		...
		<div class="container">
			...
			<div class="row justify-content-md-center">
				<div class="col-3"></div>
				<div class="col-6">
					<form action='people_edit_php.php' method=POST>
						...
						<div class="form-group row">
					    	<label for="inputPassword3" class="col-sm-2 col-form-label">Pname</label>
							<div class="col-sm-10">
								<input type="text" name="Pname" class="form-control" id="form-group-text" placeholder="Pname">
					    	</div>
						</div>
						<div class="form-group row">
							<label for="form-group-text" class="col-sm-2 col-form-label">Alive</label>
							<div class="col-sm-10">
								<input type="text" name="Alive" class="form-control" id="form-group-text" placeholder="Alive">
					    	</div>
						</div>
						<div class="form-group row">
							<label for="form-group-text" class="col-sm-2 col-form-label">Religion</label>
							<div class="col-sm-10">
								<input type="text" name="Religion" class="form-control" id="form-group-text" placeholder="Religion">
					    	</div>
						</div>
						
						<input type="submit" onclick="location.href='people_edit_php.php'"; value="Insert" / name="ins" ; class="btn btn-success btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='people_edit_php.php'"; value="Delete" / name="del" ; class="btn btn-danger btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='people_edit_php.php'"; value="Update" / name="upd" ; class="btn btn-primary btn-block btn-lg">
