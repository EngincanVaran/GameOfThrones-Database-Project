	...
	<body>
		...
		<div class="container">
			...
			<div class="row justify-content-md-center">
				<div class="col-3"></div>
				<div class="col-6">
					<form action='located_edit_php.php' method=POST>
						...
						<div class="form-group row">
					    	<label for="inputPassword3" class="col-sm-2 col-form-label">Kname</label>
							<div class="col-sm-10">
								<input type="text" name="Kname" class="form-control" id="form-group-text" placeholder="Kname">
					    	</div>
						</div>
						<input type="submit" onclick="location.href='located_edit_php.php'"; value="Insert" / name="ins" ; class="btn btn-success btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='located_edit_php.php'"; value="Delete" / name="del" ; class="btn btn-danger btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='located_edit_php.php'"; value="Update" / name="upd" ; class="btn btn-primary btn-block btn-lg">
