	...
	<body>
		...
		<div class="container">
			...
			<div class="row justify-content-md-center">
				<div class="col-3"></div>
				<div class="col-6">
					<form action='lands_edit_php.php' method=POST>
						<div class="form-group row">
							<label for="form-group-text" class="col-sm-2 col-form-label">LName</label>
							<div class="col-sm-10">
								<input type="text" name="LName" class="form-control" id="form-group-text" placeholder="LName">
					    	</div>
						</div>
						<div class="form-group row">
					    	<label for="inputPassword3" class="col-sm-2 col-form-label">Continent</label>
							<div class="col-sm-10">
								<input type="text" name="Continent" class="form-control" id="form-group-text" placeholder="Continent">
					    	</div>
						</div>
						<div class="form-group row">
							<label for="form-group-text" class="col-sm-2 col-form-label">Resources</label>
							<div class="col-sm-10">
								<input type="text" name="Resources" class="form-control" id="form-group-text" placeholder="Resources">
					    	</div>
						</div>
						
						<input type="submit" onclick="location.href='lands_edit_php.php'"; value="Insert" / name="ins" ; class="btn btn-success btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='lands_edit_php.php'"; value="Delete" / name="del" ; class="btn btn-danger btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='lands_edit_php.php'"; value="Update" / name="upd" ; class="btn btn-primary btn-block btn-lg">
