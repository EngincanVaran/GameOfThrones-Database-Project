	...
	<body>
		...
		<div class="container">
			...
			<div class="row justify-content-md-center">
				<div class="col-3"></div>
				<div class="col-6">
					<form action='houses_edit_php.php' method=POST>
						<div class="form-group row">
							<label for="form-group-text" class="col-sm-2 col-form-label">HName</label>
							<div class="col-sm-10">
								<input type="text" name="HName" class="form-control" id="form-group-text" placeholder="HName">
					    	</div>
						</div>
						<div class="form-group row">
					    	<label for="inputPassword3" class="col-sm-2 col-form-label">Motto</label>
							<div class="col-sm-10">
								<input type="text" name="Motto" class="form-control" id="form-group-text" placeholder="Motto">
					    	</div>
						</div>
						<div class="form-group row">
							<label for="form-group-text" class="col-sm-2 col-form-label">Sigil</label>
							<div class="col-sm-10">
								<input type="text" name="Sigil" class="form-control" id="form-group-text" placeholder="Sigil">
					    	</div>
						</div>
						
						<input type="submit" onclick="location.href='houses_edit_php.php'"; value="Insert" / name="ins" ; class="btn btn-success btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='houses_edit_php.php'"; value="Delete" / name="del" ; class="btn btn-danger btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='houses_edit_php.php'"; value="Update" / name="upd" ; class="btn btn-primary btn-block btn-lg">
