...
if (isset($_POST['ins']) )
{
	if ( empty($_POST['Pid']) || empty($_POST['Pname']) || empty($_POST['Alive']) || empty($_POST['Religion']))
  	{
  	...
  	else
  	{
		...
		$sql = "INSERT INTO People (Pid,Pname,Alive,Religion) VALUES ('$Pid','$Pname','$Alive','$Religion')";

		if( $link->query($sql) === false)
		{
			echo "<script>alert('Insertion Failed.');</script>";
			echo"<script>location.assign('people_edit.php')</script>";
		}
		else
		{
...
if (isset($_POST['upd']) )
{
	if (empty($_POST['Pid']) || empty($_POST['Pname']) || empty($_POST['Alive']) || empty($_POST['Religion']))
  	...
  	else
  	{
		...
		$sql = "UPDATE People SET Pname='$Pname', Alive=$Alive, Religion='$Religion' WHERE Pid='$Pid'";
