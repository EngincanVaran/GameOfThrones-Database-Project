	...
	<body>
		...
		<div class="container">
			...
			<div class="row justify-content-md-center">
				<div class="col-3"></div>
				<div class="col-6">
					<form action='rules_edit_php.php' method=POST>
						...
						<input type="submit" onclick="location.href='rules_edit_php.php'"; value="Insert" / name="ins" ; class="btn btn-success btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='rules_edit_php.php'"; value="Delete" / name="del" ; class="btn btn-danger btn-primary btn-block btn-lg">
						<input type="submit" onclick="location.href='rules_edit_php.php'"; value="Update" / name="upd" ; class="btn btn-primary btn-block btn-lg">
