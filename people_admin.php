<?php
	...
	$check = mysqli_query($link,"SELECT * FROM People ");
				...
				<div class="collapse navbar-collapse" id="navbarNav">
				    <ul class="navbar-nav mr-auto">
						...
						<li class="nav-item active">
				        	<a class="nav-link" href="people_admin.php">People <span class="sr-only">(current)</span></a>
						</li>
						<li class="nav-item">
